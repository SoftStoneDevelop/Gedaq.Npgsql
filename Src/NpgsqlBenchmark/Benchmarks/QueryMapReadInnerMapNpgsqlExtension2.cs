...
{
    public static class QueryMapReadInnerMapNpgsqlExtension2
    {
            ...
            )
        {
            ...
            if (timeout.HasValue)
            {
                ...
                ((NpgsqlParameter<System.Int32>)command.Parameters[0]).TypedValue = mParametr0;
        }
